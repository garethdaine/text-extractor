...
class TestMainCLI:
    ...
    def test_main_success_output_file(self):
        ...
        try:
            with patch('sys.argv', ['text_extractor', '--output', output_path, file_path]):
                result = main()
                assert result == 0
    ...
    def test_main_success_json_output_file(self):
        ...
        try:
            with patch('sys.argv', ['text_extractor', '--json', '--output', output_path, file_path]):
                result = main()
                assert result == 0
                assert Path(output_path).exists()
    ...
    def test_main_success_verbose_output_file(self):
        ...
        try:
            with patch('sys.argv', ['text_extractor', '--verbose', '--output', output_path, file_path]):
                result = main()
                assert result == 0
                assert Path(output_path).exists()
...
class TestMainArgumentParsing:
    ...
    def test_main_all_arguments(self):
        ...
        try:
            with patch('sys.argv', ['text_extractor', '--json', '--verbose', '--output', output_path, file_path]):
                result = main()
                assert result == 0
                assert Path(output_path).exists()
        finally:
